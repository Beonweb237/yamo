...
const TEST_USERS = [
  { key: 'admin', phone: '690000001', role: 'admin', fullName: 'Admin Test Yamo', approved: true },
  { key: 'client', phone: '690000002', role: 'client', fullName: 'Client Test Yamo', approved: true },
  { key: 'restaurant', phone: '690000003', role: 'restaurant', fullName: 'Restaurateur Test Yamo', approved: true },
  { key: 'livreur', phone: '690000004', role: 'livreur', fullName: 'Livreur Test Yamo', approved: true },
  { key: 'restaurant_pending', phone: '690000005', role: 'restaurant', fullName: 'Candidat Restaurant Test', approved: false },
  { key: 'livreur_pending', phone: '690000006', role: 'livreur', fullName: 'Candidat Livreur Test', approved: false },
];
...
async function ensureOrders(profileIds) {
  ...
  const orders = orderSpecs.map((spec, index) => ({
    ...
    ordered_for_someone_else: index === 3,
    recipient_name: index === 3 ? 'Maman Clarisse' : null,
    recipient_phone: index === 3 ? '699111222' : null,
    recipient_contact_instructions: index === 3 ? "Appeler le bénéficiaire uniquement à l'arrivée." : null,
...
async function ensureApplications(profileIds) {
  const applications = [
    ...
    },
    {
      ...
      city: 'Bafoussam',
      address: 'Tamdja',
      contact_phone: '690 00 00 05',
      notes: 'Candidature restaurant en attente pour tester la validation admin.',
      restaurant_id: null,
      reviewed_by: null,
      reviewed_at: null,
      created_at: isoHoursAgo(10),
      id_document: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#f0fdf4" width="100%" height="100%"/><text x="50%" y="45%" fill="#166534" font-size="12" text-anchor="middle" font-family="Arial">CNI Recto</text><text x="50%" y="65%" fill="#166534" font-size="10" text-anchor="middle" font-family="Arial">Rép. du Cameroun</text></svg>'),
      profile_photo: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="#dcfce7" width="100%" height="100%"/><circle cx="50" cy="40" r="20" fill="#166534"/><ellipse cx="50" cy="85" rx="30" ry="15" fill="#166534"/></svg>'),
      business_reg: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#fef3c7" width="100%" height="100%"/><text x="50%" y="45%" fill="#92400e" font-size="12" text-anchor="middle" font-family="Arial">Registre de Commerce</text><text x="50%" y="65%" fill="#92400e" font-size="10" text-anchor="middle" font-family="Arial">N° RC/YAO/2024/B/1234</text></svg>'),
      restaurant_photo: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#dbeafe" width="100%" height="100%"/><text x="50%" y="45%" fill="#1e40af" font-size="12" text-anchor="middle" font-family="Arial">Façade Restaurant</text><text x="50%" y="65%" fill="#1e40af" font-size="10" text-anchor="middle" font-family="Arial">Saveurs Test</text></svg>'),
    },
    {
      ...
      id_document: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#f0fdf4" width="100%" height="100%"/><text x="50%" y="45%" fill="#166534" font-size="12" text-anchor="middle" font-family="Arial">CNI Recto</text><text x="50%" y="65%" fill="#166534" font-size="10" text-anchor="middle" font-family="Arial">Rép. du Cameroun</text></svg>'),
      profile_photo: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="#dcfce7" width="100%" height="100%"/><circle cx="50" cy="40" r="20" fill="#166534"/><ellipse cx="50" cy="85" rx="30" ry="15" fill="#166534"/></svg>'),
      license_document: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#fef3c7" width="100%" height="100%"/><text x="50%" y="45%" fill="#92400e" font-size="12" text-anchor="middle" font-family="Arial">Permis de Conduire</text><text x="50%" y="65%" fill="#92400e" font-size="10" text-anchor="middle" font-family="Arial">Catégorie A</text></svg>'),
      insurance_document: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#ede9fe" width="100%" height="100%"/><text x="50%" y="45%" fill="#5b21b6" font-size="12" text-anchor="middle" font-family="Arial">Attestation Assurance</text><text x="50%" y="65%" fill="#5b21b6" font-size="10" text-anchor="middle" font-family="Arial">Valide 12/2026</text></svg>'),
      vehicle_photo: 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="200" height="130"><rect fill="#dbeafe" width="100%" height="100%"/><text x="50%" y="45%" fill="#1e40af" font-size="12" text-anchor="middle" font-family="Arial">Moto Honda</text><text x="50%" y="65%" fill="#1e40af" font-size="10" text-anchor="middle" font-family="Arial">Plaque: LT-1234</text></svg>'),
    },
  ];
